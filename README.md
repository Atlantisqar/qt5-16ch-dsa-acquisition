...
单通道模式下，波形区域会尽量放大，适合关注单一路信号的幅值、周期与细节变化。
...
软件内置说明窗口，可用于展示版本、用途和当前程序能力，便于现场部署或交付时快速确认软件信息。

![软件说明窗口](readme-image/软件说明.png)

### 实机测试场景

下图展示了软件与振动传感器校准设备联调时的现场测试状态，可用于说明本项目不仅支持桌面演示，也已用于实机采集验证。
